...
with open('tndistricts.tscn','w') as godot:
	...
	for i in components:
		...
		godot.write('color=Color(0.91, 0.96, 0.36, 1.0)')
	...
	for i in components:
		...
		godot.write('custom_colors/font_color=Color(0.5, 0.93, 0.94, 1.0)\n')
		godot.write('custom_colors/font_color_shadow = Color( 0.0, 0.0, 0.0, 1 )\n')
		godot.write('custom_constants/shadow_offset_x = 2\n')
		godot.write('custom_constants/shadow_offset_y = 2\n')
