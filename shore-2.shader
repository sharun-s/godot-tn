...
void fragment()
{
	...
	//if (tcol.a==0.0 && tcolleft.a==0.0){
		...
		uv += waterDistortion;
		float distFromLeft = 0.6+mainWaveAmplitude * sin(UV.y * mainWaveFrequency + TIME * mainWaveSpeed) + mainWaveAmplitude;
		float waveArea =  UV.x-distFromLeft;
