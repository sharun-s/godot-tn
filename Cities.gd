...
{name="Ambur",position = Vector2( 358.731, 114.127 ),group = "Municipality Selection grade",district = "Vellore",radius = 5},
{name="Anakaputhur",position = Vector2( 566.136, 84.5498 ),group = "Municipality Second grade",district = "Chennai",radius = 4},
{name="Arakkonam",position = Vector2( 499.289, 70.6978 ),group = "Municipality First grade",district = "Vellore",radius = 5},
{name="Arani",position = Vector2( 443.066, 130.17 ),group = "Municipality First grade",district = "Tiruvallur",radius = 5},
{name="Aranthangi",position = Vector2( 401.8, 495.789 ),group = "Municipality First grade",district = "Pudukotai",radius = 5},
{name="Arcot",position = Vector2( 448.009, 83.4997 ),group = "Municipality First grade",district = "Vellore",radius = 5},
...
{name="Avadi",position = Vector2( 562.298, 64.5399 ),group = "Municipality Special grade",district = "Thiruvallur",radius = 5},
...
{name="Jolarpettai",position = Vector2( 341.282, 146.213 ),group = "Municipality Second grade",district = "Vellore",radius = 4},
{name="Kadayanallur",position = Vector2( 162.434, 653.754 ),group = "Municipality First grade",district = "Tirunelveli",radius = 5},
...
{name="Koothanallur",position = Vector2( 477.478, 415.054 ),group = "Municipality Second grade",district = "Thiruvarur",radius = 4},
...
{name="Melvisharam",position = Vector2( 443.545, 91.7691 ),group = "Municipality Second grade",district = "Vellore",radius = 4},
...
{name="Poonamallee",position = Vector2( 563.752, 74.749 ),group = "Municipality First grade",district = "Thiruvallur",radius = 5},
...
{name="Ranipet",position = Vector2( 450.365, 92.615 ),group = "Municipality Selection grade",district = "Ranipet",radius = 5},
...
{name="Sankarankoil",position = Vector2( 191.515, 642.086 ),group = "Municipality First grade",district = "Tirunelveli",radius = 5},
...
{name="Sembakkam",position = Vector2( 571.749, 92.7771 ),group = "Municipality First grade",district = "Chennai",radius = 5},
...
{name="Tambaram",position = Vector2( 563.752, 92.2504 ),group = "Municipality Special grade",district = "Chennai",radius = 5},
{name="Tenkasi",position = Vector2( 155.164, 669.797 ),group = "Municipality First grade",district = "Tenkasi",radius = 5},
...
{name="Thiruthani",position = Vector2( 493.957, 55.7892 ),group = "Municipality Second grade",district = "Thiruvallur",radius = 4},
{name="Thiruthuraipoondi",position = Vector2( 496.865, 442.278 ),group = "Municipality Second grade",district = "Thiruvarur",radius = 4},
{name="Thiruvannamalai",position = Vector2( 412.53, 195.8 ),group = "Municipality Special grade",district = "Tiruvannamalai",radius = 5},
{name="Thiruvathipuram",position = Vector2( 481.22, 131.92 ),group = "Municipality Second grade",district = "Tiruvannamalai",radius = 4},
{name="Thiruverkadu",position = Vector2( 565.821, 71.9008 ),group = "Municipality Selection grade",district = "Thiruvallur",radius = 5},
{name="Thoothukudi",position = Vector2( 277.304, 693.132 ),group = "Muni Corporation",district = "Thoothukudi",radius = 7},
{name="Thuraiyur",position = Vector2( 347.26, 349.14 ),group = "Municipality Selection grade",district = "Tiruchirappalli",radius = 5},
{name="Thuvakudi",position = Vector2( 373.433, 409.261 ),group = "Municipality Second grade",district = "Tiruchirappalli",radius = 4},
...
{name="Tiruchirappalli",position = Vector2( 356.63, 402.171 ),group = "Muni Corporation",district = "Tiruchirapalli",radius = 7},
...
{name="Tiruvarur",position = Vector2( 494.975, 406.838 ),group = "Municipality First grade",district = "Thiruvarur",radius = 5},
...
{name="Vaniyambadi",position = Vector2( 347.098, 128.712 ),group = "Municipality Selection grade",district = "Vellore",radius = 5},
...
{name="Walajapet",position = Vector2( 448.009, 82.0413 ),group = "Municipality Second grade",district = "Vellore",radius = 4}]
